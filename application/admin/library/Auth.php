...
class Auth extends \fast\Auth
{
    ...
    public function getSidebar($params = [], $fixedPage = 'dashboard')
    {
        ...
        $menu = $nav = '';
        if (Config::get('cbjlayui.multiplenav')) {
            $topList = [];
            ...
            //<li class="layui-nav-item layui-this layui-bg-blue"><a href="#"><i class="layui-icon layui-icon-home"></i>系统</a></li>

            foreach ($topList as $index => $item) {
                $childList = Tree::instance()->getTreeMenu($item['id'], '<li class="layui-nav-item"><a href="@url@addtabs" addtabs="@id" url="@url" py="@py" pinyin="@pinyin"><i class="@icon"></i>@title</a></li>');
            ...
            $menu = Tree::instance()->getTreeMenu(0, '<li class="layui-nav-item"><a href="@url@addtabs" addtabs="@id" url="@url" py="@py" pinyin="@pinyin"><i class="@icon"></i>@title</a></li>', $select_id, '', 'ul', 'class="layui-nav"');
            if ($selected) {
                ...
                $nav .= '<li class="layui-nav-item layui-this layui-bg-blue"><a href="#"><i class="layui-icon layui-icon-home"></i>系统</a></li>';
            }
            if ($referer) {
                ...
                $nav .= '<li id="tab_' . $referer['id'] . '" class="layui-nav-item layui-this layui-bg-blue"><a href="#con_' . $referer['id'] . '" node-id="' . $referer['id'] . '" aria-controls="' . $referer['id'] . '"  role="tab"  data-toggle="tab"><i class="' . $referer['icon'] . ' fa-fw"></i>' . $referer['title'] . '</a></li>';
            }
        }
